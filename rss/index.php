...
<body>
  <div id="sidebar" class="sidebar" tabindex="-1">
    
      <ul>
        <li class="sidebar-ul-li">
          <img src="img/nc.png" loading="lazy" alt="Logo noticias" class="logo">
        </li>
  ...
  <div class="card">
    ...
    <div class="contenedor-menu" id="br-menu">
...
<button  type="button"  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" class="btn btn-dark">Añadir <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
  ...
  <div id="toast1" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000">
    <div class="toast-header">
      <img src="img/msg.png" loading="lazy" class="rounded mr-2" alt="mensaje" style="width: 40px;">
    ...
    <div class="toast-body">
      Se añadio correctamente.
                ...
                <div class="contenedor-info" id="informacion">
    ...
    if($resultado->num_rows > 0){
      ...
      while ($values = $resultado->fetch_array()) {
          ...
          <div class="card mb-3" style="max-width: 100%; ">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="<?php echo $values['enclosure']; ?>" loading="lazy" alt="AMLOs" Style="with:300px;" class="img_inner">
              </div>
              <div class="col-md-8">
                <div class="card-body">
